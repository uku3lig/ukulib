...
public class IntSliderOption implements WidgetCreator {
    ...
    private final OptionInstance.TooltipSupplier<@NotNull Integer> tooltipSupplier;
     ...
     */
    public IntSliderOption(String key, int initialValue, IntConsumer setter, IntFunction<Component> valueToText, int min, int max, int step, OptionInstance.TooltipSupplier<@NotNull Integer> tooltipSupplier) {
        this.key = key;
