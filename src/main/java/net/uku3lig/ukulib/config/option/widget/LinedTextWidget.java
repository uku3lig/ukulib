...
public class LinedTextWidget extends StringWidget {
    ...
    public void renderWidget(GuiGraphics drawContext, int mouseX, int mouseY, float delta) {
        ...
        if (drawLine) {
            ...
            drawContext.hLine(this.getX() + this.padding, this.getX() + this.padding + lineWidth, lineY, 0xFFFFFFFF);
            drawContext.hLine(this.getX() + this.width - this.padding - lineWidth, this.getX() + this.width - this.padding, lineY, 0xFFFFFFFF);
        }
    }
}
