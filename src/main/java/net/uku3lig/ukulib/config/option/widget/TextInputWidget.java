...
public class TextInputWidget extends ClickableWidget implements CheckedOption {
    ...
    private void setCursor(int cursor, boolean select) {
    ...
    private void setCursorToStart(boolean shiftKeyPressed) {
        this.setCursor(0, shiftKeyPressed);
    }

    private void setCursorToEnd(boolean shiftKeyPressed) {
    ...
    private void setSelectionEnd(int index) {
