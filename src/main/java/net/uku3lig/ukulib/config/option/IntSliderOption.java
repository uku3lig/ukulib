...
public class IntSliderOption implements WidgetCreator {
     ...
     */
    public static final IntFunction<Component> DEFAULT_INT_TO_TEXT = i -> Component.nullToEmpty(String.valueOf(i));
    ...
    private final OptionInstance.TooltipSupplier<Integer> tooltipFactory;
     ...
     */
    public IntSliderOption(String key, int initialValue, IntConsumer setter, IntFunction<Component> valueToText, int min, int max, int step, OptionInstance.TooltipSupplier<Integer> tooltipFactory) {
        this.key = key;
